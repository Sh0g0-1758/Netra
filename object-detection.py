...
# Define the class names, model configuration, and model weights paths
classNames = []
...
if __name__ == "__main":
    ...
    # Notify the start of object detection and Using Festival Text is converted into Speech
